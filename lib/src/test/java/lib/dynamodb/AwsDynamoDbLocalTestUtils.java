...
/**
 * Helper class for initializing AWS DynamoDB to run with sqlite4java for local
 * testing.
 *
 * Copied from:
...
public class AwsDynamoDbLocalTestUtils {
	...
	/**
	 * Calculates the possible Library Names for finding the proper sqlite4j native
	 * library and returns the directory with the most specific matching library.
	 *
	 * @param osName      The value of <code>"os.name"</code> system property
	 *                    (<code>System.getProperty("os.name")</code>).
	 * @param runtimeName The value of <code>"java.runtime.name"</code> system
	 *                    property
	 *                    (<code>System.getProperty("java.runtime.name")</code>).
	 * @param osArch      The value of <code>"os.arch"</code> system property
	 *                    (<code>System.getProperty("os.arch")</code>).
	 * @param osArch      The classpath split into strings by path separator. Value
	 *                    of <code>"java.class.path"</code> system property
	 *                    (<code>System.getProperty("os.arch")</code>) split by
	 *                    <code>File.pathSeparator</code>.
	 * @return
	 */
	public static String getLibPath(final String osName, final String runtimeName, final String osArch,
	...
	/**
	 * Calculates the possible Library Names for finding the proper sqlite4java
	 * native library.
	 *
	 * Based on the internal calculation of the sqlite4java wrapper
	 * <a href="https://bitbucket
	 ...
	 * @param arch Operating System Architecture used by sqlite4java to get native
	 *             library.
	...
	/**
	 * Calculates the Operating System Architecture for finding the proper
	 ...
	 * @param osArch The value of <code>"os.arch"</code> system property
	 *               (<code>System.getProperty("os.arch")</code>).
	 * @param os     Operating System Name used by sqlite4java to get native
	 *               library.
	 * @return Operating System Architecture used by sqlite4java to get native
	 *         library.
	 */
	...
	/**
	 * Calculates the Operating System Name for finding the proper sqlite4java
	 * native library.
	 *
	 * Based on the internal calculation of the sqlite4java wrapper
	 * <a href="https://bitbucket
	...
	public static String getOs(final String osName, final String runtimeName) {
		...
		if (osName == null) {
			...
			if (loweCaseOsName.startsWith("mac") || loweCaseOsName.startsWith("darwin")
	 ...
	 *
	 * @param classPath     Value of <code>"java.class.path"</code> system property
	 *                      (<code>System.getProperty("os.arch")</code>).
	 * @param pathSeparator Value of path separator
	 *                      (<code>File.pathSeparator</code>).
